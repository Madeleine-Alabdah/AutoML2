...
# AutoKeras integration for classification
...
# AutoKeras integration for regression
...
# AutoKeras parameters for classification
autokeras_classification_params = {
    "max_trials": [5, 10, 15],  # You can adjust the number of trials
}

# AutoKeras parameters for regression
autokeras_regression_params = {
    "max_trials": [5, 10, 15],  # You can adjust the number of trials
}
